...
import utils.AccessRelease;
import utils.AccessRequest;
import utils.ManagementRequest;
import utils.SleepStep;
import utils.UserScript;
...
public class UserActor extends AbstractActor {
	...
	public void onReceive(Object msg) throws Exception {
		...
		// Find correspond request in pending request list and delete it.		
			...
			//System.out.println("$$$"+getSelf()+" Received access denied");
			...
			//System.out.println("$$$"+getSelf()+" Received management granted");
