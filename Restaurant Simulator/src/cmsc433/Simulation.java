...
public class Simulation {
	...
	public static List<SimulationEvent> runSimulation(
		...
		MainServer.init(numTables, machineCount);
		



		// Start up machines (this is done by the line above)
		...
		for(int i=0; i<numCooks; i++) {
			cookThreads[i] = new Thread(new Cook("Cook"+(i+1), numCustomers));
			cookThreads[i].start();
		}
